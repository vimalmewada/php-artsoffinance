        ...
        <div class="row pt_sm--80 pb--80 pb_sm--40">
            <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                <div class="footer-two-single-wized left pt--50">
                    <img src="../../assets/img/logo1.png" alt="Logo" width="200" height="100">
                ...
                <div class="footer-one-single-wized mid-bg">
                    ...
                    <div class="opening-time-inner">
                        <div class="single-opening">
                            ...
                            <p class="time">9 AM - 10 PM</p>
                        </div>
                        <div class="single-opening">
                            <p class="day">Saturday</p>
                            <p class="time">Demo Classes</p>
                        </div>
                        <div class="single-opening mb--30 mb_sm--10">
                            <p class="day">Sunday</p>
                            <p class="time">Day Off</p>
                        </div>
                        <a routerLink="/contact" class="rts-btn btn-primary contact-us">Contact Us</a>
                    </div>
                </div>
            </div>
            <!-- footer mid area end -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <p>Copyright &copy; 2025 by <strong>Arts Of Finance</strong>. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
